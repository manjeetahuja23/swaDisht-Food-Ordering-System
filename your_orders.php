											...
											if (!mysqli_num_rows($query_res) > 0) {
												...
												while ($row = mysqli_fetch_array($query_res)) {
													...
													<tr>
															...
															if ($status == "" or $status == "NULL") {
																...
																<button type="button" class="btn btn-info"
																	style="font-weight:bold;"><span class="fa fa-bars"
																		aria-hidden="true"> Ready to pickup</button>
																<?php
															}
															if ($status == "in process") { ?>
																<button type="button" class="btn btn-warning"><span
																		class="fa fa-cog fa-spin" aria-hidden="true"></span> In
																	Process!</button>
																<?php
															}
															if ($status == "closed") {
														...
														<td data-column="E-Reciept"> <a
																href="bill_generator.php?o_id=<?php echo $row['o_id']; ?>"
																class="btn btn-primary btn-flat btn-addon btn-xs m-b-10"><i
																	class="fa fa-download" style="font-size:16px"></i></a>
														</td>
